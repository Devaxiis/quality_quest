...
sealed class Style{
  ...
  static const widgetTitleST = TextStyle(fontSize: 17.5,fontWeight: FontWeight.w700,color: Color(0xFF212121),);
  static const notificationST = TextStyle(fontWeight: FontWeight.w600,color: Colors.black,);

  // #music screen
  static const musicEffectST = TextStyle(fontWeight: FontWeight.w600,color: Colors.black,);
  static const musicTitleST = TextStyle(fontSize: 17.5,fontWeight: FontWeight.w700,color: Color(0xFF212121),);

  // #About App Screen
  static const aboutAppST = TextStyle(fontWeight: FontWeight.w600,color: Colors.black,);
  static const appVersionST = TextStyle(fontSize: 20,fontWeight: FontWeight.w500,);
  static const descriptionQualityQuestST = TextStyle(fontWeight: FontWeight.w400,color: Colors.black87,fontSize: 20,letterSpacing: -1,);

  // #Library
  static final libraryST = TextStyle(fontSize: 22.5,color: Colors.deepPurpleAccent.shade700,fontWeight: FontWeight.w800,);

  // #Join
  static const joinSearchST = TextStyle(fontSize: 18, fontWeight: FontWeight.normal);
  static const joinTitleST = TextStyle(fontSize: 17, fontWeight: FontWeight.bold);
  static final joinFollowingST = TextStyle(color: Colors.deepPurpleAccent.shade700,);

  // #HomeScreen
  static final homeQualityQuestST = TextStyle(fontSize: 22.5,color: Colors.deepPurpleAccent.shade700,fontWeight: FontWeight.w800,);
  static final homeExamQualityQuestST = TextStyle(fontSize: 25,color: Colors.deepPurpleAccent.shade700,fontWeight: FontWeight.w800,);
  static const homeExamQuestionST = TextStyle(color: Color(0xff6949ff),fontSize: 40,fontWeight: FontWeight.w800);
  static final homeDiscoverQualityQuestST = TextStyle(fontSize: 23,color: Colors.deepPurpleAccent.shade700,fontWeight: FontWeight.w800);

  // #Create Quiz
  static const createQuizST = TextStyle(color: Color(0xFF6949FF),fontWeight: FontWeight.w800,);
  static final createWantToMakePublicST = TextStyle(fontSize: 18,color: Colors.grey.shade800,fontWeight: FontWeight.w800,);
  static const createAddCoverImageST = TextStyle(color: Color(0xFF6949FF),fontWeight: FontWeight.w700,fontSize: 18,);
  static const createAddAnswerST = TextStyle(color: Color(0xFF295ECC),fontWeight: FontWeight.w800,fontSize: 28,);
